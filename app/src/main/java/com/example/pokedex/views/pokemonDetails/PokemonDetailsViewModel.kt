...
class PokemonDetailsViewModel @Inject constructor(val repository: PokemonRepository) : ViewModel() {
    ...
    fun loadPokemon(name: String) {
        _pokemonDetailsViewState.value = PokemonDetailsViewState.Loading
